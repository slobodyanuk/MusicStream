...
/**
 * Created by Serhii Slobodyanuk on 12.04.2016.
 */
public class ViewAnimator<T extends Resourceble> {
    ...
    public void showMenuContent() {
        ...
        for (int i = 0; i < size; i++) {
            View viewMenu = mActivity.getLayoutInflater().inflate(yalantis.com.sidemenu.R.layout.menu_list_item, null);
            final int finalI = i;
    ...
    private void switchItem(Resourceble slideMenuItem, int topPosition) {
        this.mFragment = animatorListener.onSwitch(slideMenuItem, mFragment, topPosition);
        hideMenuContent();
    }
